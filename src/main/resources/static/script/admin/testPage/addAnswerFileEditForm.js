function addInsideFileAnswerFormStyles(button) {
...
function displayFileAnswerForm(answerId, oldFileVar) {
    ...
    input.type = 'file';
    input.id = 'fileAnswerInput';

    var button = document.createElement('button');
    button.textContent = 'Зберегти';
    button.setAttribute("onclick", "editAnswerFile(" + answerId + ")");

    var buttonDeleteFile = document.createElement('button');
    buttonDeleteFile.textContent = 'Видалити';
    buttonDeleteFile.setAttribute("onclick", "deleteAnswerFile(" + answerId + ")");
    ...
    addInsideFileAnswerFormStyles(button);
    addInsideFileAnswerFormStyles(buttonDeleteFile);
